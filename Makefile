...
update_database.ml:; if test ${OCAML_VERSION} = "4.14" ; \
                     ...
                     else update_database_${OCAML_UNARY_VERSION}.ml update_database.ml ; \
                     fi
...
pa_j.cmo: pa_j.ml; if test ${OCAML_BINARY_VERSION} = "3.0" ; \
                   ...
                   elif test ${OCAML_BINARY_VERSION} = "4.14" ; \
                        then echo "Uses pa_hol_syntax"; touch pa_j.cmo; \
